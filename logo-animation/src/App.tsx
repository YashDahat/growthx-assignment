...
function App() {
  return (
    <div className="min-h-screen bg-[#060606] flex flex-col items-center justify-center animate-[move-up_2.0s_ease-out_forwards]">
      {/* Star Shape */}
        ...
        {/* Logo Bottom - Rectangle with circles cut from bottom corners */}
        <div className="relative w-[200px] h-[100px]">
            {/* White rectangle */}
            {/*<div className="absolute inset-0 bg-white animate-[fill-diagonal_1.5s_ease-out_forwards]"></div>*/}
